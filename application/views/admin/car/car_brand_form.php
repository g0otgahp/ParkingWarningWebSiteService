    ...
    <div class="card card-nav-tabs">
      <div class="card-header" data-background-color="">
        ...
        <form name="Form1" ng-submit="car_brand_save()">
          ...
          <a href="<?php echo site_url('admin/car/car_list'); ?>" class="btn btn-danger">ยกเลิก</a>
        </div>
        <div class="card-content">
          <div class="row">
            ...
            <!-- <div class="col-md-3">
              <h4>โลโก้</h4>
            <input type="file" name="file" id="file" img-UploadBrand bind="car_brand.car_brand_pic">
            <p><img height="200px" class="img" ng-src="<?php echo base_url('upload/images/brand'); ?>/{{car_brand.car_brand_pic}}" alt=""></p>
        </div> -->
      </form>
      </div>
    </div>
